...
df2016 = tableau_complet [tableau_complet.year == 2016].iloc[:100,:]

def classement(df2016, max_rows=len(df2016)):
    return html.Table([
        html.Thead(
...
layout = html.Div([
    ...
    html.Button('Chargement', id='chargment_val', n_clicks=0),
